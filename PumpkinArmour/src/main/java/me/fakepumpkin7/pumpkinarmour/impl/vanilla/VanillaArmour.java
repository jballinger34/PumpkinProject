...
public class VanillaArmour implements Listener {
    ...
    public void onEquipVanillaArmour(ArmorEquipEvent e){
        ...
        switch(item.getType()){
            case DIAMOND_HELMET:
                item = new ItemBuilder(item).addNBT("pumpkin-armour-id", "vanilla-diamond")
                        .setDefence(3)
                        .build();
            ...
            case DIAMOND_BOOTS:
                ...
                break;
            case IRON_HELMET:
                item = new ItemBuilder(item).addNBT("pumpkin-armour-id", "vanilla-iron")
                        .setDefence(2)
                        .build();
                e.getPlayer().getEquipment().setHelmet(item);
                break;
            ...
            case CHAINMAIL_HELMET:
                item = new ItemBuilder(item).addNBT("pumpkin-armour-id", "vanilla-chain")
                        .setDefence(2)
                        .build();
                e.getPlayer().getEquipment().setHelmet(item);
                break;
            ...
            case CHAINMAIL_BOOTS:
                ...
                break;
            case GOLD_HELMET:
                item = new ItemBuilder(item).addNBT("pumpkin-armour-id", "vanilla-gold")
                        .setDefence(2)
                        .build();
                e.getPlayer().getEquipment().setHelmet(item);
                break;
            ...
            case GOLD_BOOTS:
                ...
                break;
            case LEATHER_HELMET:
                item = new ItemBuilder(item).addNBT("pumpkin-armour-id", "vanilla-leather")
                        .setDefence(1)
                        .build();
                e.getPlayer().getEquipment().setHelmet(item);
                break;
